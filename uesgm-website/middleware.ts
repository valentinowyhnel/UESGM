...
function addSecurityHeaders(response: NextResponse) {
  ...
  response.headers.set('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vitals.vercel-analytics.com; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data: https://*.supabase.co https://*.googleusercontent.com; connect-src 'self' https://*.supabase.co https://vitals.vercel-analytics.com; font-src 'self' data:; frame-ancestors 'none'; upgrade-insecure-requests;")
